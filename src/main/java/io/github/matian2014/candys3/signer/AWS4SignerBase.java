...
public abstract class AWS4SignerBase {
    ...
    /** precomputed SHA256 hash of an empty request body **/
     ...
     * @return the canonicalized header names.
     */
     ...
     * @param queryParameters the query string parameters.
     * @param canonicalizedHeaderNames the canonicalized header names.
     * @param canonicalizedHeaders the canonicalized headers.
     * @param bodyHash the hash of the request body.
    ...
    /**
     * Hashes the file using the SHA-256 algorithm.
